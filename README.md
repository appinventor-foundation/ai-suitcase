...
Running the script will set up all the software needed, including the MIT App Inventor sources and the servers to both host the mobile apps editor and the ML training pipelines. The sources have been conveniently packaged in the form of containers, and will be automatically downloaded and configure through the script.
